...
(def items
  [{:id 0 :w 411 :h 664 :title "Baby" :src "img/baby.jpg" :category :painting :desc "Oil painting of some baby, attempting a diverse colorscheme"}
   ...
   {:id 22 :w 592 :h 869 :title "Julie series nr 3" :src "img/js3.jpg" :category :photo :desc "Third in a photo series taken during medieval festival and developed in a darkroom"}
   {:id 23 :w 543 :h 827 :title "Julie series nr 4" :src "img/js4.jpg" :category :photo :desc "Forth in a photo series taken during medieval festival and developed in a darkroom"}
   {:id 24 :w 574 :h 854 :title "Julie series nr 5" :src "img/js5.jpg" :category :photo :desc "Fifth in a photo series taken during medieval festival and developed in a darkroom"}
   ...
   {:id 34 :w 638 :h 878 :title "Nomad Equipped" :src "img/nomad-eq.jpg" :category :drawing :desc "Nomad with equipment, comic book concept"}
   {:id 35 :w 592 :h 725 :title "Ouroboros" :src "img/ouroboros.jpg" :category :drawing :desc "Unfinished sketch of ouroboros"}
   {:id 36 :w 752 :h 696 :title "Pattern Composition" :src "img/pattern_comp.jpg" :category :drawing :desc "One of many patterns inspired loosely on the art nouveau style"}
   {:id 37 :w 542 :h 769 :title "Pray Pencil" :src "img/pray_pencil.jpg" :category :drawing :desc "Sketch of two praying figures"}
   {:id 38 :w 1545 :h 380 :title "House gardener logo suggestion" :src "img/precore.png" :category :vector :desc "Logo suggestion for a design/gardening company. Not used but I still like it"}
