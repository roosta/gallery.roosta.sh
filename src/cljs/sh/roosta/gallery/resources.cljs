...
(def items
  [
   ...
   {:id 3 :w 961 :h 343 :title "Cake" :src "img/cake.jpg" :category :design :desc "One of several design suggestions for a webpage header"}
   ...
   {:id 11 :w 1017 :h 723  :title "Dunes" :src "img/dunes.jpg" :category :painting :desc "Sand dunes abstracted"}
   ...
   {:id 13 :w 121 :h 104 :gif true :title "Pixel Explosion" :src "img/expl.gif" :category :game :desc "Explosion from an unfinished shmup game"}
   ...
   {:id 16 :w 711 :h 711  :title "Goat Boys LP cover design" :src "img/gbcover.jpg" :category :design :desc "Cover design for Goat Boys debut album" :link "https://open.spotify.com/artist/2GadG4cFR4bNH6fyLFt8JK"}
   ...
   {:id 21 :w 779 :h 1087  :title "Selv Portrait with background" :src "img/inkdanfull.jpg" :category :painting :desc "Selv portrait with a superimposed background"}
   {:id 22 :w 625 :h 859 :title "Selv Portrait" :src "img/inkdans.jpg" :category :painting :desc "Selv portrait using ink on plastic"}
   {:id 23 :w 486 :h 566 :title "Insectlike" :src "img/insectlike.jpg" :category :drawing :desc "One of several inksect inspired mask drawings"}
   ...
   {:id 32 :w 489 :h 741 :title "Candle lamp" :src "img/lamp.jpg" :category :diy :desc "Lamp made for christmas using laser cutter, paint and patience. See link for vector blueprint" :link "https://roosta.sh/gallery/img/lamp_vector.svg"}
   ...
   {:id 38 :w 624 :h 788 :title "Nomad Angle" :src "img/nomad-ang.jpg" :category :painting :desc "Titular nomad drawn from an angle. Comic book concept"}
   ...
   {:id 45 :w 610 :h 873 :title "Salt" :src "img/salt.jpg" :category :painting :desc "Salt/sand dunes abstracted illustration"}
   {:id 46 :w 592 :h 800 :title "Sectered" :src "img/secterd.jpg" :category :painting :desc "Gass mask wearing kid in the series of insect inspired gass masks"}
   ...
   {:id 48 :w 1019 :h 723 :title "Sea of sand" :src "img/sos.jpg" :category :painting :desc "Mountain surrounded by sand. Looks in hindsight more like water"}
   ...
   {:id 51 :w 872 :h 461 :title "Thirst" :src "img/thirst.jpg" :category :painting :desc "Thirsty fellow drawn with ink on rice paper"}
   {:id 52 :w 875 :h 593 :title "Three men" :src "img/tmen.jpg" :category :painting :desc "Card playing fellows drawn with ink on rice paper"}
   ...
   {:id 54 :w 648 :h 628 :title "Wind Cover" :src "img/wind.jpg" :category :design :desc "Cover for a 60s inspired jam band. Marker on plastic"}
